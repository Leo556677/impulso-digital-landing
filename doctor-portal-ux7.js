(()=>{
  ...
  openTele=function(x){
    ...
    try{fs=Number(localStorage.getItem('do_tele_font'))||(innerWidth<600?34:44);sr.value=localStorage.getItem('do_tele_speed')||'32'}catch{fs=innerWidth<600?34:44;sr.value=32}applyF();speedL();play=false;countdownActive=false;playI();syncTeleSettings();tele.classList.add('on');document.body.style.overflow='hidden';scr.scrollTop=0;wordPhase=0;wordRowKey='';setTimeout(focus,30);
  };
})();
